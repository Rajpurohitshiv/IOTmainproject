...
const char *ssid = "Shiv@20";      // Your network id
const char *password = "77777777"; // your network password
...
unsigned long myChannelNumber = 2295314;        // Your Channel Number (Without Brackets)
const char *myWriteAPIKey = "MTYCEOUMMYD3PPME"; // Your Write API Key
const char *myReadAPIKey = "MZTF9PHQIKM1TIBK";  // Your Write API Key
